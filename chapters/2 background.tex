...
In it, NER was employed to filter out proper names form its lists of vocabulary.
The only exceptions from this were the names of countries, which were manually added back into the lists after the automatic filtering.
