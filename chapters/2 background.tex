...
\section{Ordering Lists of Vocabulary} \label{sec:state-of-the-art-vocabulary-selection}
...
\subsubsection {Raw frequency of words in corpus}
A simple ordering of words by how often they appear in a corpus.

\subsubsection {Frequency with stopwords filtered out}
