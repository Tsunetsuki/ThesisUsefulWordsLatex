...
Therefore, the following section will attempt to define utility and related concepts more carefully, in order to state the aim of this work more formally.
...
How exactly this proxy metric is calculated will be discussed in Section \ref{sec:xai-methods}.
