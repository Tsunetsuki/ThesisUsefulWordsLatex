This chapter describes in detail my approach for word utility evaluation, using the concepts explained in chapter \ref{seq:definition-of-terms}.
I first restate the problem more precisely, then describe a hypothetical approach for evaluating word utility with human test subjects. After pointing out the unfeasibility of such a testing method, I suggest ways to solve the problem with AI and XAI, using the concepts referred to in chapter \ref{seq:basic-nlp-concepts}.
...
To repeat the introductory sentence of chapter \ref{seq:definition-of-terms}:
...
Thus, with this model in mind, we can translate some of the concepts introduced in chapters \ref{seq:definition-of-terms} into technical components to see how we could implement a technical solution to the problem of analyzing the utility of words.
