...
\begin{table}[ht]
	\centering
	\resizebox{\textwidth}{!}{%
		\input{data/performance wikipedia-article.tex}
	}
	\caption{Similarity of vocabulary lists on Wikipedia Articles}
...
\begin{table}[ht]
	\centering
	\resizebox{\textwidth}{!}{%
		\input{data/performance opensubs-subtitle.tex}
	}
	\caption{Performance of vocabulary lists on OPUS Subtitles.}
...
\begin{table}[ht]
	\centering
	\resizebox{\textwidth}{!}{%
		\input{data/similarity_heatmap_table_single.tex}
	}
...
\begin{table}[ht]
	\centering
	\resizebox{\textwidth}{!}{%
		\input{data/similarity_heatmap_table_big.tex}
	}
	\caption{Similarity of vocabulary lists, big. Black boxes represent missing values.}
