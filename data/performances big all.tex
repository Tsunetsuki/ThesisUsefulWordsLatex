...
\midrule 
\textbf{[Mean]} & \textbf{0.47} & \textbf{0.53} & \textbf{0.55} & \textbf{0.62} & \textbf{0.71} & \textbf{0.82} \\
\bottomrule
\end{tabular}
    }
...
\midrule 
\textbf{[Mean]} & \textbf{0.55} & \textbf{0.63} & \textbf{0.67} & \textbf{0.74} & \textbf{0.83} & \textbf{0.90} \\
\bottomrule
\end{tabular}
    }
...
\midrule 
\textbf{[Mean]} & \textbf{0.57} & \textbf{0.61} & \textbf{0.64} & \textbf{0.70} & \textbf{0.79} & \textbf{0.88} \\
\bottomrule
\end{tabular}
    }
...
Attention - Sent. Emb. & \cellcolor[RGB]{58,76,192}\textbf{0.53} & \cellcolor[RGB]{95,126,231}0.57 & \cellcolor[RGB]{134,169,252}0.61 & \cellcolor[RGB]{205,217,236}0.69 & \cellcolor[RGB]{244,157,126}0.79 & \cellcolor[RGB]{181,8,39}0.88 \\
Single Token Ablation - NSP & \cellcolor[RGB]{58,76,192}\textbf{0.53} & \cellcolor[RGB]{93,125,230}0.57 & \cellcolor[RGB]{137,172,252}0.61 & \cellcolor[RGB]{194,212,243}0.67 & \cellcolor[RGB]{243,197,175}0.75 & \cellcolor[RGB]{207,70,61}0.85 \\
...
Single Token Summary - NSP & \cellcolor[RGB]{58,76,192}\textbf{0.53} & \cellcolor[RGB]{108,142,241}0.58 & \cellcolor[RGB]{142,177,253}0.62 & \cellcolor[RGB]{201,215,238}0.68 & \cellcolor[RGB]{246,186,159}0.76 & \cellcolor[RGB]{221,96,76}0.84 \\
...
\midrule 
\textbf{[Mean]} & \textbf{0.53} & \textbf{0.58} & \textbf{0.62} & \textbf{0.68} & \textbf{0.78} & \textbf{0.87} \\
\bottomrule
\end{tabular}
    }
