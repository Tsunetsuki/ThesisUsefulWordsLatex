	...
	\scalebox{0.75}{
		\begin{tikzpicture}[node distance=1.8cm and 2.5cm, every node/.style={font=\small}]
			...
			\node (d4) [data, right=of n4] {
				...
				\\
				Current sentence:  \texttt{"abraham lincoln 1863."}\\
				Current performance: \texttt{0.4}\\
			};
			\node (d5) [data, right=of n5] {
				Remaining words: \texttt{['faced', 'enmity', 'in']} \\
				\quad \textbf{faced:} \\
				\quad \quad \texttt{"abraham lincoln faced 1863."} $\rightarrow$ \texttt{0.6} \\
				\quad \textbf{enmity:} \\
				\quad \quad 	\texttt{"abraham lincoln enmity 1863."} $\rightarrow$ \texttt{0.7}\\
				\quad \textbf{in:} \\
				\quad \quad \texttt{"abraham lincoln in 1863."} $\rightarrow$ \texttt{0.5}\\
				\\
				Next best word: \textbf{enmity}\\
				Utility of \textbf{enmity}: $0.7 - 0.4 = 0.3$ \\
				Current sentence:  \texttt{"abraham lincoln enmity 1863."}\\
				Current performance: \texttt{0.7}\\
			};
			\node (d6) [data, right=of n6] {
				Remaining words: \texttt{['faced', 'in']} \\
				\textbf{faced:} \\
				\quad \texttt{"abraham lincoln faced enmity 1863."} $\rightarrow$ \texttt{0.9} \\
				\textbf{in:} \\
				\quad \texttt{"abraham lincoln enmity in 1863."} $\rightarrow$ \texttt{0.8} \\
				\\
				Next best word: \textbf{faced}\\
				Utility of \textbf{faced}: $0.9 - 0.7 = 0.2$ \\
				Current sentence:  \texttt{"abraham lincoln faced enmity 1863."}\\
				Current performance: \texttt{0.9}\\
			};
			\node (d7) [data, right=of n7] {
				Remaining words: \texttt{['in']} \\
				\textbf{in:} \\
				\quad \texttt{"abraham lincoln faced enmity in 1863."}$\rightarrow$ \texttt{1} \\
\\
				Next best word: \textbf{in}\\
				Utility of \textbf{in}: $1 - 0.9 = 0.1$ \\
				Current sentence: \texttt{"abraham lincoln faced enmity in 1863."}\\
