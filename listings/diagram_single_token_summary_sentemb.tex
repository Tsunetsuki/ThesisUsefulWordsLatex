...
\begin{tabular}{@{}ll@{}}
        \textbf{faced:}  & $\frac{\text{CosDist}(\vec{a}, \vec{r})}{\text{CosDist}(\vec{e}, \vec{r})} = \texttt{0.5}$ \\
        \textbf{enmity:} & $\frac{\text{CosDist}(\vec{b}, \vec{r})}{\text{CosDist}(\vec{e}, \vec{r})} = \texttt{0.7}$ \\
        \textbf{in:}     & $\frac{\text{CosDist}(\vec{c}, \vec{r})}{\text{CosDist}(\vec{e}, \vec{r})} = \texttt{0.3}$ \\
    \end{tabular}
			};
